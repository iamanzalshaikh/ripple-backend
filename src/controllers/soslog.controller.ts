...
//       // Rate limit: max 3 SOS per hour
//       const oneHourAgo = new Date(Date.now() - 60 * 60 * 1000);
//       const recentSOS = await SOSLog.countDocuments({
//         userId,
...
//           success: false,
//           message: 'Too many SOS attempts. Maximum 3 per hour.',
...
//         data: {
//           sosId: sosLog._id.toString(),
//           liveUrl: `https://herridez.com/live/${liveShareToken}`,
...
export const updateSOSLocation = async (req: AuthRequest, res: Response) => {
   ...
   */
// ============================================
// File: controllers/soslog.controller.ts
// Update your existing getLiveSOSTracking function
// ============================================
...
export const getLiveSOSTracking = async (
    ...
    try {
      ...
      res.json({
        ...
        data: {
          sosId: sosLog._id.toString(),
          riderName: sosLog.userId?.name || 'Anonymous',
          riderAvatar: sosLog.userId?.avatarUrl,
