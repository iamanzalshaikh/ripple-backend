...
import { getNotifications, markAllNotificationsRead, markNotificationRead, testNotification } from '../controllers/notifcation.controller.js';

const notificationRouter: Router = express.Router();

const wrappedGetNotifications: any = getNotifications;
const wrappedMarkNotificationRead: any = markNotificationRead;
const wrappedMarkAllNotificationsRead: any = markAllNotificationsRead;
const wrappedTestNotification: any = testNotification;

notificationRouter.get('/', isAuth, wrappedGetNotifications);
notificationRouter.patch('/:id/read', isAuth, wrappedMarkNotificationRead);
notificationRouter.patch('/read-all', isAuth, wrappedMarkAllNotificationsRead);
notificationRouter.post('/test', isAuth, wrappedTestNotification);
