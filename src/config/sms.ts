...
//     // Optionally add DLT template ID if configured
//     if (config.TECHMORE_TEMPLATE_ID) {
//       // Key name depends on Techmore configuration; commonly "templateid"
...
//     if (config.TECHMORE_TEMPLATE_ID) {
//       console.log(`[SMS] Template ID: ${config.TECHMORE_TEMPLATE_ID}`);
//     } else {
//       console.log(`[SMS] Template ID: (not configured)`);
//     }
...
//       console.log("\n⚠️  NOTE: If SMS not received, possible reasons:");
//       console.log("  1. Techmore account may have delivery issues");
//       console.log("  2. Phone number might be blocked or invalid");
//       console.log("  3. Network/carrier delays (can take 1-5 minutes)");
...
//   otp: string,
// ): Promise<boolean> => {
//   const message = `Welcome to RIDEZ! Your verification OTP is: ${otp}. Valid for 10 minutes. Do not share this code with anyone. - RIDEZ`;
...
//   otp: string,
// ): Promise<boolean> => {
//   const message = `Your RIDEZ login OTP is: ${otp}. Valid for 10 minutes. Do not share this code. If you did not request this, please ignore. - RIDEZ`;
