...
export const initializeSocket = (httpServer) => {
    ...
    io.on("connection", (socket) => {
         ...
         */
        socket.on("send-message-ride", async (data) => {
            try {
        ...
        socket.on("stop-typing-ride", (data) => {
            try {
         ...
         */
        socket.on("send-message-group", async (data) => {
            try {
    ...
    logger.info("✅ Socket.io server initialized with Notifications + Rides + Groups + Private Chat");
    return io;
};
/**
