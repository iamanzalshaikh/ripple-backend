...
const wrappedStartRide = startRide;
const wrappedStreamChunk = streamChunk;
const wrappedPauseRide = pauseRide;
const wrappedResumeRide = resumeRide;
const wrappedEndRide = endRide;
const wrappedGetMyRides = getMyRides;
const wrappedGetRideById = getRideById;
const wrappedDeleteRide = deleteRide;
