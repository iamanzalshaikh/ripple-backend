...
const wrappedCreatePost = createPost;
const wrappedGetFeed = getFeed;
const wrappedLikePost = likePost;
const wrappedGetComments = getComments;
const wrappedCommentPost = commentPost;
const wrappedDeleteComment = deleteComment;
const wrappedDeletePost = deletePost;
