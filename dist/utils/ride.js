 ...
 */
export const calculateAvgSpeed = (distanceKm, durationSeconds) => {
 ...
 */
export const calculateCalories = (distanceKm, avgSpeedKmh, riderWeightKg = 65) => {
 ...
 */
export const calculateEstimatedDuration = (distanceKm, avgSpeedKmh = 25) => {
    if (avgSpeedKmh === 0)
        return 0;
 ...
 */
export const calculateRideDifficulty = (distanceKm, elevationGainM, avgSpeedKmh) => {
    let score = 0;
    if (distanceKm < 20)
        score += 10;
        ...
        score += 40;
    if (elevationGainM < 200)
        score += 10;
    else if (elevationGainM < 500)
        score += 20;
    else if (elevationGainM < 1000)
        score += 30;
    else
        score += 40;
    if (avgSpeedKmh < 15)
