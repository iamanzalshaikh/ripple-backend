 ...
 */
const awardBadge = async (userId, badgeCode, badgesAwarded) => {
    try {
        ...
        await User.updateOne({ _id: userId }, { $addToSet: { badges: badge._id } });
        // Step 2: Increment counter
        await User.updateOne({ _id: userId }, { $inc: { totalBadges: 1 } });
 ...
 */
export const rideWorker = new Worker('ride-processing', async (job) => {
...
//# sourceMappingURL=ride.queue.js.map